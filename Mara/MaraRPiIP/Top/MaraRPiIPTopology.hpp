// ======================================================================
// \title  MaraRPiIPTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef MARARPIIP_MARARPIIPTOPOLOGY_HPP
#define MARARPIIP_MARARPIIPTOPOLOGY_HPP
// Included for access to MaraRPiIP::TopologyState and MaraRPiIP::ConfigObjects::pingEntries. These definitions are required by the
 ...
 * MaraRPiIP::TopologyState see: MaraRPiIPTopologyDefs.hpp.
 *
