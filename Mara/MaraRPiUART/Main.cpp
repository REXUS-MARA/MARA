...
#include <Mara/MaraRPiUART/Top/MaraRPiUARTTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    MaraUART::setupTopology(inputs);
    MaraUART::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    MaraUART::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
